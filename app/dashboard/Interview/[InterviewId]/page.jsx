            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                <div className='flex flex-col gap-5 p-5 rounded-lg border'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <h2 className='text-lg'><strong>Job Description/Tech Stack:</strong> {interviewData?.techStack || 'Loading...'}</h2>
                        <h2 className='text-lg'><strong>Years of Experience:</strong> {interviewData?.experience || 'Loading...'}</h2>
                    </div>
                    ...
                    <div className='p-5 border rounded-lg border-yellow-300 bg-yellow-200'>
                        ...
                        <h2 className='mt-3 text-yellow-500'>
                            {process.env.NEXT_PUBLIC_INFORMATION || 'Prepare well, keep your environment quiet, and stay confident during the mock interview.'}
                        </h2>
                    </div>
                </div>
